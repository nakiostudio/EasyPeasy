...
extension PositionAttribute {
     ...
     */
    public func to(_ view: NSView, _ attribute: ReferenceAttribute? = nil) -> Self {
     ...
     */
    @available(OSX 10.11, *)
    public func to(_ layoutGuide: NSLayoutGuide, _ attribute: ReferenceAttribute? = nil) -> Self {
