...
internal extension Item {
     ...
     */
    @discardableResult internal func apply(attributes: [Attribute]) -> [NSLayoutConstraint] {
    ...
    @discardableResult internal func apply(attribute: Attribute) -> ActivationGroup? {
