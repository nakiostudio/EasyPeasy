...
class TweetView: NSView {
    ...
    func configure(with tweet: TweetModel) {
        ...
        let userInfo = TweetView.attributedStringWithName(name: tweet.name, username: tweet.displayableUsername)
        self.userInfoLabel.attributedStringValue = userInfo
        let displayableDate = TweetView.attributedStringWithDisplayableDate(string: tweet.displayableDate)
        self.displayableDateLabel.attributedStringValue = displayableDate
        let tweetString = TweetView.attributedStringWithTweet(tweet: tweet.tweet)
