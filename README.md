...
![demo](assets_readme/demo_project.gif)
...
**EasyPeasy** is a well documented framework and all the documented methods and
classes are available in [Cocoadocs](http://cocoadocs.org/docsets/EasyPeasy).
